...
* 구문 매치 키워드로 보았을 때, 가장 높은 총 전환은 "promo" 광고 그룹이며, 그 뒤를 이어 "coupon"와 "offer"가 따랐음, 대부분의 기기는 데스크톱을 통해 사용되었음
...
* 12월에 회사가 고려 단계에 초점을 맞추고자 한다면, 광고 그룹 "promo"와 "free shipping"을 사용할 수 있습니다.
